        ...
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                <div class="panel-heading">Dashboard</div>
					...
					<a href="http://localhost/laravelis/svari8/public/products/create" class="btn btn-primary"> Naujojo</a>
...
<div class="container">
    ...
    <h3 class="text-center">Laravel 5 - Column sorting with pagination example from scratch</h3><br>
			...
			<div class="row">
				<div class="col-md-8">
				<form method="POST" action='{{url("/products/ieskau")}}'>
				{{csrf_field() }}
        ...
        @if($products->count())
            ...
            @foreach($products as $key => $product)
                ...
                <tr>
					...
					<td>{{ $product->kaina }}</td>
					<td>	<img style="width:50px; height:50px" src="/../laravelis/svari8/storage/app/public/cover_images/{{$product->cover_image}}">
</td>
