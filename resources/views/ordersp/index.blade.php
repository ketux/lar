    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">Užsakymai2</div>
				
				
	<!-- search opcija -->
	<div class="row">
		<div class="col-md-8">
				<form method="POST" action='{{url("/ordersp/search")}}'>
				{{csrf_field() }}
							...
							<tr>
								...
								@foreach($orders as $order)
									<tr>
										...
										<td>{{$order->kaina}}</td>
										<th>	<img style="width:80%" src="/../laravelis/svari8/storage/app/public/cover_images/{{$order->cover_image}}">
</th>

										<td>
											<a href="/../laravelis/svari8/public/ordersp/{{$order->id}}/edit" class="btn btn-default">Edit</a>
										</td>
